...
min.features <- 200
min.cells <- 3
pc.num <- 50         # number of PCs
resolution <- 0.5    # higher values will generate more clusters, and vice versa, recommended values for experiments: 0.05, 0.1, 0.15, 0.2, 0.25, 0.3
